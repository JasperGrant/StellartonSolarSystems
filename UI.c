...
int main(void){
	...
	while(1){
		...
		switch(input){
			...
			case 10:
				//Sub menu
			    printf("Select function:\n1. Change a Customer Feild\n2. Change a Product Feild\n3. Change a Supplier Feild\n");
			    
			    scanf("%d", &input2);
			    
			    switch(input2){
			    	case 1:
			    		printf("Update Customer feilds\n");
			    		changecustomer();
			    		break;
			    	
			    	case 2:
			    		printf("Update Product feilds\n");
			    	    changeproduct();
			    	    break;
			    	
			    	case 3:
			    		printf("Update Supplier feilds\n");
			    	    changesupplier();
			    	    break;
				}
				break;
